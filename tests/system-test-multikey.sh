...
# Create gpg keys.
echo "Step 1: Creating new GPG keys to use for testing:"
num_keys=10
key_fps=()
(
    set -x
...
echo "Step 5: Test that clone fails with no matching key:"
{
    # Create a new empty GPG home
...
echo "Step 6: Cloning the second repository using gitception:"
{
    (
        set -x
        git clone -b "${default_branch}" \
